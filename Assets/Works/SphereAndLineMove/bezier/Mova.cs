...
namespace N20170311.Bezier {
	...
	public class Mova
	{
		...
		public Mova (GameObject parent)
		{
			...
			pBezierLine = new PBezierLine (parent);
...
//			p1p2 = p2 - p1;
			...
			pBezierLine.setColor(stroke_color);
...
//			pline.update(pp, p2);
			pBezierLine.updateFromTo(tt, 1.0f);
